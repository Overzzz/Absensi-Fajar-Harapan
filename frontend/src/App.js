...
function App() {
  ...
  const fetchSiswa = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/siswa', {headers: { Authorization: `Bearer ${token}` }});
  ...
  const handleSiswaDelete = async (idSiswa) => {
    if (window.confirm('Hapus siswa ini?')) {
      try { await axios.delete(`https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/siswa/${idSiswa}`, {headers: { Authorization: `Bearer ${token}` }}); fetchSiswa(); 
  ...
  const fetchGuru = async () => {
    ...
    try {
      setGuruLoading(true);
      const response = await axios.get('https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/guru', {headers: { Authorization: `Bearer ${token}` }});
  ...
  const handleGuruDelete = async (idGuru) => {
    if (window.confirm('Hapus guru ini?')) {
      try { await axios.delete(`https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/guru/${idGuru}`, {headers: { Authorization: `Bearer ${token}` }}); fetchGuru();
