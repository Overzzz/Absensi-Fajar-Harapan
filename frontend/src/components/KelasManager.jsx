...
function KelasManager({ token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/kelas', 
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/kelas/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchKelas();
    } catch (err) {
