...
function SiswaEdit({ token }) {
  ...
  useEffect(() => {
    ...
    const fetchSiswaById = async () => {
      try {
        const response = await axios.get(`https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/siswa/${id}`, {
    ...
    const fetchKelas = async () => {
      try {
        const response = await axios.get('https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/kelas', {
          headers: { Authorization: `Bearer ${token}` }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://impressive-caralie-overzzz-8b9026c7.koyeb.app/api/siswa/${id}`, dataSiswaUpdate, {
         headers: { Authorization: `Bearer ${token}` }
      });
